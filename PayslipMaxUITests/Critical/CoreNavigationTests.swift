...
final class CoreNavigationTests: XCTestCase {
    // swiftlint:disable implicitly_unwrapped_optional no_shared_business_singletons
    var app: XCUIApplication!
    // swiftlint:enable implicitly_unwrapped_optional no_shared_business_singletons
