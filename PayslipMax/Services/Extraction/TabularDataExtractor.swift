...
class TabularDataExtractor: TabularDataExtractorProtocol {
    ...
    let spatialAnalyzer: SpatialAnalyzerProtocol?
    ...
    func shouldExcludeCode(_ code: String) -> Bool {
    ...
    func isEarningsCode(_ code: String) -> Bool {
    ...
    func isDeductionCode(_ code: String) -> Bool {
