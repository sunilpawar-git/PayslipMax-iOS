...
/// Handles pattern application strategies for different pattern types
final class PatternApplicationStrategies {
    
    // MARK: - Pattern Type Handlers
    
    /// Applies a regular expression pattern to the text to extract a value.
    func applyRegexPattern(_ pattern: ExtractorPattern, to text: String) -> String? {
        do {
    ...
    func applyKeywordPattern(_ pattern: ExtractorPattern, to text: String) -> String? {
    ...
    func applyPositionBasedPattern(_ pattern: ExtractorPattern, to text: String) -> String? {
