...
enum MockError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .clearAllDataFailed: 
            return "Mock clear all data operation failed"
        case .unlockFailed: 
            return "Mock unlock operation failed"
        case .setupPINFailed: 
            return "Mock PIN setup failed"
        case .verifyPINFailed: 
            return "Mock PIN verification failed"
        case .clearFailed: 
            return "Mock clear operation failed"
        case .processingFailed: 
            return "Mock processing operation failed"
        case .incorrectPassword: 
            return "Mock incorrect password error"
        case .extractionFailed: 
            return "Mock extraction operation failed"
        }
    }
} 