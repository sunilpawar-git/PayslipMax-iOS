...
@MainActor
protocol PasswordProtectedPDFHandler: ObservableObject {
    var showPasswordEntryView: Bool { get set }
    var currentPasswordProtectedPDFData: Data? { get set }
    var currentPDFPassword: String? { get set }
...
@MainActor
protocol ErrorHandler: ObservableObject {
