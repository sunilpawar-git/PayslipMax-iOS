...
final class EncryptionServiceTest: XCTestCase {
    ...
    func testProtocolConformance() {
        ...
        XCTAssertTrue(service is EncryptionServiceProtocol)
    }
    ...
    /// Test 13: Verify multiple concurrent encryptions
    func testConcurrentEncryptions() throws {
        ...
        // When: Perform multiple concurrent encryptions
        for _ in 0..<10 {
            group.enter()
        ...
        XCTAssertEqual(encryptedResults.count, 10)
