...
final class SimplifiedPayslipParserTests: XCTestCase {
    ...
    func testLowConfidenceForMissingData() async {
        ...
        // With new totals-first system: Gross (20) + Deductions (20) + Perfect Net math (50) + 1 core field (5) = 95%
        // Net is auto-calculated as 248310 - 100124 = 148186, which is mathematically perfect
        XCTAssertGreaterThan(payslip.parsingConfidence, 0.9, "Perfect totals math should yield high confidence despite missing fields")
    }
