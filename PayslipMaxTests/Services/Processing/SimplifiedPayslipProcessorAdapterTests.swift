...
final class SimplifiedPayslipProcessorAdapterTests: XCTestCase {
    ...
    func testLowerConfidenceForPartialParsing() throws {
        // Partial parsing: some fields missing
        let sampleText = """
        Name: Partial User
        08/2025
        BPAY: 100000
        ...
        // Partial parsing should have lower confidence
        XCTAssertLessThan(confidence, 0.8, "Partial parsing should have <80% confidence")
    }
