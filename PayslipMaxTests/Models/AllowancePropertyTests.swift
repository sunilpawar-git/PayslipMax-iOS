...
class AllowancePropertyTests: AllowanceTestCase {
    ...
    func testAllowance_NameProperty_CanBeModified() {
        // Given
        let allowance = Allowance(name: "Original Name", amount: 1000.0, category: "Test")
    ...
    func testAllowance_AllProperties_CanBeSetToEmptyStrings() {
        // Given
        let allowance = Allowance(name: "Test", amount: 1000.0, category: "Test")
    ...
    func testAllowance_Amount_CanBeSetToExtremeValues() {
        // Given
        let allowance = Allowance(name: "Extreme Test", amount: 1000.0, category: "Test")
